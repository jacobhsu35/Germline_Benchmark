...
wkdir=/work2/lynn88065/Dragen/Pipeline_compare/WGS_benchmark/20201210
...
sample_list=/work2/lynn88065/Dragen/Pipeline_compare/WGS_benchmark/20201210/sample_list.txt

while read -r subject VCF_PATH;do
	cd $wkdir &&
