...
HG="hg38"
Date="20201210"
workdir="/work2/lynn88065/Dragen/Pipeline_compare/WES_benchmark/${Date}"
...
WES_VCF_hg38="/work2/lynn88065/Dragen/Pipeline_compare/WES_benchmark/BedFileForBenchmark/WES_GIAB_HG001_selectvariants_bedinterect_IDT_v1_output.vcf"
BED_bedintersect="/work2/lynn88065/Dragen/Pipeline_compare/WES_benchmark/BedFileForBenchmark/HG001_GRCh38_GIAB_highconf_bedintersect_IDT_v1.bed"

REF_38="/project/GP1/u3710062/AI_SHARE/reference/From_illumina/reference_illumina/hg38.fa"
export HGREF=${REF_38}

Query="/work2/lynn88065/Dragen/Pipeline_compare/WES_benchmark/20201210/query_vcf_select/WES_GIAB_HG001_selectvariants_bedinterect_IDT_v1_SAMPLE_NAME_output.vcf"

##################################################################################
############################## WGS benchmark######################################
##################################################################################

$PYTHON $HC $WES_VCF_hg38 $Query -f $BED_bedintersect -r $REF_38 -o ${ID}-ve --engine-vcfeval-path $rtg --engine=vcfeval --engine-vcfeval-template $sdf_38
